variable "bucket_name" {
  ...
  type = list(string)
  default = ["terrafrombuclketfortestingmeta001","terrafrombuclketfortestingmeta002"]
...
variable "bucket_name_set" {
  description = "The name of the S3 bucket"
  type = set(string)
  default = ["terrafrombuclketfortestingmeta003","terrafrombuclketfortestingmeta004"]
